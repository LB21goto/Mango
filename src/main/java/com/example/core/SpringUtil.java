...
import static com.example.constant.Constant.DEFAULT_PREFIX_DISTINCTION_NAME;
import static com.example.constant.Constant.PREFIX_DISTINCTION_NAME;
...
public class SpringUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public static String getPrefixDistinctionName() {
        ...
        return DEFAULT_PREFIX_DISTINCTION_NAME;
    }
